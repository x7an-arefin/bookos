      ...
      <div class="w-full max-w-md relative">
        ...
        <div class="relative bg-card/60 backdrop-blur-md border border-border/80 rounded-2xl shadow-xl p-8">
          ...
          <div class="flex flex-col items-center mb-8">
            ...
            <h2 class="text-2xl font-bold font-serif tracking-tight text-foreground">Create Your Account</h2>
            <p class="text-xs text-muted-foreground mt-1">Join BookOS and start writing your masterpiece</p>
          </div>
          ...
          <form [formGroup]="registerForm" (ngSubmit)="onSubmit()" class="space-y-4">
            <!-- Email -->
            <div>
              <label for="email" class="block text-xs font-semibold uppercase tracking-wider text-muted-foreground mb-1">Email Address</label>
              <div class="relative">
                <input
                  id="email"
                  type="email"
            ...
            <!-- Password -->
            <div>
              <label for="password" class="block text-xs font-semibold uppercase tracking-wider text-muted-foreground mb-1">Password</label>
              <div class="relative">
                <input
                  id="password"
                  type="password"
              ...
              <p class="text-[10px] text-muted-foreground mt-1">Must be at least 10 characters and contain at least one digit.</p>
            </div>

            <!-- Confirm Password -->
            <div>
              <label for="confirmPassword" class="block text-xs font-semibold uppercase tracking-wider text-muted-foreground mb-1">Confirm Password</label>
              <div class="relative">
                <input
                  id="confirmPassword"
                  type="password"
            ...
            <button
              type="submit"
              [disabled]="registerForm.invalid || authStore.getIsLoading()"
              class="w-full relative flex items-center justify-center bg-primary hover:bg-primary/95 text-primary-foreground font-medium py-2.5 px-4 rounded-lg shadow-sm focus:outline-none transition-all disabled:opacity-50 disabled:cursor-not-allowed text-sm mt-3"
            >
